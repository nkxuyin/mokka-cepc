...
INSTANTIATE(yoke05_cepc)

G4bool yoke05_cepc::ContextualConstruct(const CGAGeometryEnvironment &env, 
...
G4LogicalVolume * yoke05_cepc::BuildRPC1Box(              G4Box *ChamberSolid,
						     muonSD *theSD, 
						     G4int layer_id,
						     ...
						     Database *db )
{
  ...
  Control::Abort("yoke05_cepc::BuildRPC1Box: invalid ChamberSolidEnvelope",MOKKA_OTHER_ERRORS);
  return NULL; 
}
...
G4LogicalVolume * yoke05_cepc::BuildRPC1ECShape(G4Polyhedra *ChamberSolide,
					   muonSD* theSD,
					   G4int layer_id,
					   G4UserLimits* pULimits, 
					   Database *db,
...
{ 
  ...
  Control::Abort("yoke05_cepc::BuildRPC1ECBox: invalid ChamberSolidEnvelope",MOKKA_OTHER_ERRORS);
  return NULL; 
}
